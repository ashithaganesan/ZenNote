    ...
    <div className="w-72 h-full bg-slate-100 border-r border-slate-200 flex flex-col">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between px-2 py-1 mb-2">
                ...
                <div className="flex space-x-1">
                  <button onClick={() => onAddFolder(null)} className="p-1.5 hover:bg-slate-200 rounded-lg text-slate-500 transition-colors" title="New Folder">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" /></svg>
                  </button>
                  <button onClick={() => onAddNote(null)} className="p-1.5 hover:bg-slate-200 rounded-lg text-slate-500 transition-colors" title="New Root Note">
      ...
      <div className="p-4 border-t border-slate-200 bg-white">
        <div className="flex items-center space-x-3 text-slate-500 text-sm">
          <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-indigo-600 to-violet-600 flex items-center justify-center text-white font-black text-sm shadow-md">S</div>
          <div className="flex-1 overflow-hidden">
            <p className="font-bold text-slate-800 leading-none truncate">Student Account</p>
            <p className="text-[10px] uppercase font-black text-indigo-500 mt-1">Free Tier</p>
          </div>
        </div>
      </div>
    </div>
